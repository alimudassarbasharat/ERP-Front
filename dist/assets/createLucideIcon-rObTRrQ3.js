import{ak as n}from"./index-xvPUEXLW.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const k=({name:t,iconNode:e,absoluteStrokeWidth:o,"absolute-stroke-width":r,strokeWidth:c,"stroke-width":a,size:i=s.width,color:h=s.stroke,...l},{slots:u})=>n("svg",{...s,...l,width:i,height:i,stroke:h,"stroke-width":d(o)||d(r)||o===!0||r===!0?Number(c||a||s["stroke-width"])*24/Number(i):c||a||s["stroke-width"],class:C("lucide",l.class,...t?[`lucide-${w(p(t))}-icon`,`lucide-${w(t)}`]:["lucide-icon"])},[...e.map(m=>n(...m)),...u.default?[u.default()]:[]]);/**
 * @license lucide-vue-next v0.553.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v=(t,e)=>(o,{slots:r,attrs:c})=>n(k,{...c,...o,iconNode:e,name:t},r);export{v as c};
