<template>
  <div ref="wrapperElementRef" class="relative custom-date-picker-wrapper">
    <!-- Input Trigger -->
    <div 
 ...
 * Common component - use everywhere for date filters
 */
...
const updateDropdownPosition = () => {
  // Use ref to get the correct input element for this specific instance
  const inputEl = wrapperElementRef.value?.querySelector('.custom-date-input')
  if (inputEl) {
